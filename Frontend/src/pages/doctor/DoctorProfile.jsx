                    ...
                    <Card className="mb-8 border-0 overflow-hidden relative bg-gradient-to-br from-teal-600 to-blue-600 text-white p-0 shadow-2xl">
                        ...
                        <div className="p-8 md:p-12 relative z-10 flex flex-col md:flex-row gap-8 items-center md:items-start">
                            ...
                            <Avatar
                                ...
                                name={formData.name}
                                fallback="D"
                                className="w-32 h-32 md:w-40 md:h-40 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center text-4xl font-bold border-4 border-white/20 shadow-2xl shrink-0 overflow-hidden"
                            />
