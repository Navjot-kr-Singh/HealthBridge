                            ...
                            return (
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    <Avatar
                                        ...
                                        name={doc.name}
                                        fallback="D"
                                        className="w-16 h-16 rounded-full bg-slate-100 flex items-center justify-center text-slate-400 font-bold text-2xl border-2 border-slate-50 overflow-hidden"
                                    />
